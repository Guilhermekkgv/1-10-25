...
Linux.FrameColor = Color3.fromRGB(53, 53, 57)
Linux.MainFrameColor = Color3.fromRGB(7, 7, 7)
...
function Linux.SaveResizeSettings()
    local success, result = pcall(function()
        local resizeData = {
            ...
            IsMinimized = Linux.SavedResize.IsMinimized
        }
...
function Linux.LoadResizeSettings()
    local success, result = pcall(function()
        if readfile and isfile(Linux.ConfigFolder .. "/resize.json") then
            ...
            Linux.SavedResize.IsMinimized = resizeData.IsMinimized or false
            return true
        else
...
function Linux.Create(config)
    ...
    globalConnectionManager:addConnection(MinimizeButton.MouseButton1Click:Connect(function()
        ...
        Linux.SavedResize.IsMinimized = isMinimized
    ...
    if Linux.SavedResize.IsMinimized then
        task.wait(0.5)
        isMinimized = false
